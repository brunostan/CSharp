...
## [6. AutoMapper](https://github.com/AutoMapper/AutoMapper)
...
Console.WriteLine(destinationObject.Id);         // Saída: 1
Console.WriteLine(destinationObject.FullName);   // Saída: John Doe
Console.WriteLine(destinationObject.Age);        // Saída: 30
```
